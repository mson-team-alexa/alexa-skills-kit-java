...
public final class Stories {
    ...
    static {
        STORY_COLLECTION.add(
        		new AesopFable("Belling the Cat", 
        				"<speak>" + "The Mice once called a meeting to decide on a plan to free themselves of their enemy, <prosody pitch=\"low\">the Cat.</prosody>"
			        		+ "At least they wished to find some way of knowing when she was coming, so they might have time to run away. Indeed, <emphasis level=\"strong\">something</emphasis> had to be done, "
			        		...
			        		+"\"<prosody pitch=\"high\">I have a plan that seems very simple, but I know it will be successful."
			        		+"All we have to do is to hang a bell about the Cat's neck. When we hear the bell ringing we will know immediately that our enemy is coming.</prosody>\""
			        		...
			        		+"\"<emphasis level=\"strong\">I will say that the plan of the young Mouse is very good. But let me ask one question: Who will bell the Cat?\"</emphasis></speak>",
